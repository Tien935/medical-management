      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 font-semibold mt-1">
            Danh sách bệnh nhân và nhân viên hệ thống
          </p>
        </div>
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm font-semibold text-slate-600">
                        <div>
                          <i className="far fa-envelope mr-2 text-teal-500"></i>{" "}
                          {user.email || "N/A"}
                        </div>
                        <div className="mt-1">
                          <i className="fas fa-phone-alt mr-2 text-teal-500"></i>{" "}
                          {user.phone || "N/A"}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className="w-10 h-10 rounded-xl bg-slate-100 text-slate-600 hover:bg-teal-600 hover:text-white transition shadow-sm"
                        >
                          <i className="fas fa-user-edit"></i>
                        </button>
                        <button
                          onClick={() => handleDelete(user.id)}
                          className="w-10 h-10 rounded-xl bg-slate-100 text-slate-600 hover:bg-red-600 hover:text-white transition ml-2 shadow-sm"
                        >
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  className="w-full p-3 rounded-xl border border-slate-200 focus:border-teal-500 outline-none bg-white font-bold"
                  value={formData.role}
                  onChange={(e) =>
